...
ReactDOM.render(
  <div id="nameMain">
    <h1 tabIndex="12">Neighborhood map</h1>
    <span className="listView" tabIndex="1">List View</span>
  </div>,
  document.getElementById("nameContainer")
);

const element = <div className="menu"><h1 className="resetfilters" tabIndex="1" role="button">Reset Filters</h1><h1 className="places" tabIndex="1" role="button" id="Food">UDF</h1><h1 className="places" tabIndex="1" role="button" id="Food">My first job at Richie's</h1><h1 className="places" tabIndex="1" role="button" id="Nature">The Scioto River</h1><h1 className="places" tabIndex="1" role="button" id="Events">Pumpkin Show</h1><h1 className="places" tabIndex="1" role="button" id="Food">Circleville's Juice Bar</h1></div>;
ReactDOM.render(
 element,
  document.getElementById("menu")
);

const btns = <div><div onClick={toggleMenu} className="typeMenuBtn" tabIndex="1"><span >Type</span></div><p className="menuType hide" tabIndex="1">Food</p><p className="menuType hide" tabIndex="1">Nature</p><p className="menuType hide" tabIndex="1">Events</p></div>;
ReactDOM.render(
  btns,
...
fetch(url)
  ...
  .then(function(jsonResponse) {
    ...
    isOnWater = `<p>This location is on water according to <a href="https://onwater.io/" target="_blank">https://onwater.io/</a></p>`;
    }
    else if (jsonResponse.water === false){
    isOnWater = `<p>This location is not on water according to <a href="https://onwater.io/" target="_blank">https://onwater.io/</a></p>`;
    }
    else{
...
function initMap() {
  ...
  var map = new google.maps.Map(
      document.getElementById('map'), {
          ...
          zoomControl: false,
          center: cville});
  function gm_authFailure() {alert("broken") };
